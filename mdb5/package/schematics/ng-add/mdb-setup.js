...
const mdbModules = [
    ...
    { name: 'MdbAutocompleteModule', path: 'mdb-angular-ui-kit/autocomplete' },
    { name: 'MdbCarouselModule', path: 'mdb-angular-ui-kit/carousel' },
    { name: 'MdbChartModule', path: 'mdb-angular-ui-kit/charts' },
    { name: 'MdbCheckboxModule', path: 'mdb-angular-ui-kit/checkbox' },
    { name: 'MdbCollapseModule', path: 'mdb-angular-ui-kit/collapse' },
    { name: 'MdbDatepickerModule', path: 'mdb-angular-ui-kit/datepicker' },
    { name: 'MdbDropdownModule', path: 'mdb-angular-ui-kit/dropdown' },
    { name: 'MdbFormsModule', path: 'mdb-angular-ui-kit/forms' },
    { name: 'MdbInfiniteScrollModule', path: 'mdb-angular-ui-kit/infinite-scroll' },
    { name: 'MdbLazyLoadingModule', path: 'mdb-angular-ui-kit/lazy-loading' },
    { name: 'MdbLightboxModule', path: 'mdb-angular-ui-kit/lightbox' },
    { name: 'MdbLoadingModule', path: 'mdb-angular-ui-kit/loading' },
    { name: 'MdbModalModule', path: 'mdb-angular-ui-kit/modal' },
    { name: 'MdbNotificationModule', path: 'mdb-angular-ui-kit/notification' },
    { name: 'MdbPopconfirmModule', path: 'mdb-angular-ui-kit/popconfirm' },
    ...
    { name: 'MdbRatingModule', path: 'mdb-angular-ui-kit/rating' },
    { name: 'MdbRippleModule', path: 'mdb-angular-ui-kit/ripple' },
    { name: 'MdbScrollbarModule', path: 'mdb-angular-ui-kit/scrollbar' },
    { name: 'MdbScrollspyModule', path: 'mdb-angular-ui-kit/scrollspy' },
    { name: 'MdbSelectModule', path: 'mdb-angular-ui-kit/select' },
    { name: 'MdbSidenavModule', path: 'mdb-angular-ui-kit/sidenav' },
    { name: 'MdbSmoothScrollModule', path: 'mdb-angular-ui-kit/smooth-scroll' },
    { name: 'MdbStepperModule', path: 'mdb-angular-ui-kit/stepper' },
    { name: 'MdbStickyModule', path: 'mdb-angular-ui-kit/sticky' },
    { name: 'MdbTableModule', path: 'mdb-angular-ui-kit/table' },
    { name: 'MdbTabsModule', path: 'mdb-angular-ui-kit/tabs' },
    { name: 'MdbTimepickerModule', path: 'mdb-angular-ui-kit/timepicker' },
