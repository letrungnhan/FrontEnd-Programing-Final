...
class MdbSidenavComponent {
    ...
    triggerEvents(startEvent, completeEvent = '') {
    ...
    _setupContent() {
        ...
        this._initialContentStyle = Object.assign({}, window.getComputedStyle(this._contentEl));
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.7", ngImport: i0, type: MdbSidenavComponent, decorators: [{
        ...
        return [{ type: i0.Renderer2 }, { type: i0.ElementRef }, { type: i0.ChangeDetectorRef }, { type: i1$1.ConfigurableFocusTrapFactory }, { type: MdbSidenavLayoutComponent, decorators: [{
                        type: Inject,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.7", ngImport: i0, type: MdbSidenavItemComponent, decorators: [{
        ...
        return [{ type: i0.Renderer2 }, { type: i0.ElementRef }, { type: i1$2.Router, decorators: [{
                        type: Optional
