...
class MdbStickyDirective {
    ...
    _changeBoundaryPosition() {
        ...
        const parentOffset = Object.assign({ height: this._elementRef.nativeElement.parentElement.getBoundingClientRect().height }, this._getOffset(this._elementRef.nativeElement.parentElement));
        let stopPoint;
